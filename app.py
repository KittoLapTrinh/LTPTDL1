...
cred = credentials.Certificate('./iuh-20064421-firebase-adminsdk-mh84b-e9dd3fda03.json')
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20064421').stream())
...
app.layout = html.Div(
    children=[
        html.Div(
            children=[
                html.H3(
                    "Trường: IUH, Lớp: DHHTTT16B Võ Minh Tiến", className="header-title"
